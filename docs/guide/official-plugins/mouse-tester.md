...
A mouse tester plugin for [TINKER](https://github.com/liriliri/tinker), with real-time button, scroll, and movement visualization.

![Screenshot](https://raw.githubusercontent.com/liriliri/tinker-plugins/master/packages/tinker-mouse-tester/screenshot.png)
