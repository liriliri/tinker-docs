...
TINKER 支持 [Windows x64](https://release.liriliri.io/tinker/TINKER-2.1.3-win-x64.exe)、[macOS Apple silicon](https://release.liriliri.io/tinker/TINKER-2.1.3-mac-arm64.dmg)、[macOS Intel chip](https://release.liriliri.io/tinker/TINKER-2.1.3-mac-x64.dmg)、[Linux DEB](https://release.liriliri.io/tinker/TINKER-2.1.3-linux-amd64.deb) 和 [Linux RPM](https://release.liriliri.io/tinker/TINKER-2.1.3-linux-x86_64.rpm) 平台，下载安装后直接点击桌面图标开始使用。
